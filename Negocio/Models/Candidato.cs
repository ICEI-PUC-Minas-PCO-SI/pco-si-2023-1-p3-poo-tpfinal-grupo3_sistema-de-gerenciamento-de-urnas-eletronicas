...
namespace Model.Models
{
    public class Candidato : ModelBase
    {
        ...
        public virtual HashSet<Eleicao> SegundoTurnos { get; set; } = new HashSet<Eleicao>();
        #endregion
        ...
        public override void Validate()
        {
            ...
            else
            {
                ...
                else if ((this.Cargo != ECargo.DEPUTADO_ESTADUAL&& this.Cargo != ECargo.DEPUTADO_FEDERAL) &&this.Numero.Length != 2)
                {
                    msg.AppendFormat("{0}: {1}", "Número", "Prefeitos, Presidentes e Vereadores devem conter 2 digitos /n");
                    hasException = true;
                }
